...
private:
	...
	GLuint normalBuffer;
	int sceneIndex;
	int sceneIndicesOffset;
	int sceneVerticesOffset;
...
public:
	...
	int getSceneIndicesOffset();
	int getSceneVerticesOffset();
	void setSceneIndicesOffset(int offset);
	void setSceneVerticesOffset(int offset);
};
